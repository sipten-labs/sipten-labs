...
- 🚀 I build **high-end, premium, 3D-interactive web experiences** — not just websites, but visual products.
- 🎨 I design **UI/UX at a premium 3D level**, focused on motion, depth, and product feel.
- 📊 I'm equally strong on the **data side** — Advanced Excel, Power Query, VBA, and workflow automation.
...
| Domain | Skills |
|---|---|
| **Full Stack Web Development** | HTML5, CSS3, JavaScript, TypeScript, React, Next.js, Node.js |
| **Premium 3D Web** | Three.js, WebGL, GSAP, scroll-based 3D interactions, micro-animations |
| **UI/UX Design (3D & Premium)** | Figma, design systems, prototyping, product-grade visual polish |
